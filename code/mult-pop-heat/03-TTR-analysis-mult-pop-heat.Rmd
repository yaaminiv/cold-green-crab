...
```{r}
TTRmodelWA_timepoint <- lsmeans(TTRmodelWA, pairwise~timepoint, adjust = "tukey") #Pairwise tukey test for timepoint
...
```{r}
TTRmodelME_timepoint <- lsmeans(TTRmodelME, pairwise~timepoint, adjust = "tukey") #Pairwise tukey test for timepoint
...
```{r}
TTRmodelME_genotype <- lsmeans(TTRfullGenotypeME, pairwise~as.factor(genotype), adjust = "tukey") #Pairwise tukey test for genotype
...
```{r}
TTRmodelNH_genotype <- lsmeans(TTRfullGenotypeNH, pairwise~as.factor(genotype), adjust = "tukey") #Pairwise tukey test for genotype

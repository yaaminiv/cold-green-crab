...
- roll all temperature loggers together
- see if there is better syntax for joining multiple tables with data.table
  - THE LAST ONE NEEDS TO BE TANK 1A
...
```{r}
temp <- as.data.table(tank3a)[as.data.table(tank2b), on = "dateTime", roll = T, rollends = F][as.data.table(tank3b), on = "dateTime", roll = T, rollends = F][as.data.table(tank4a), on = "dateTime", roll = T, rollends = F][as.data.table(tank4b), on = "dateTime", roll = T, rollends = F][as.data.table(tank6a), on = "dateTime", roll = T, rollends = F][as.data.table(tank6b), on = "dateTime", roll = T, rollends = F][as.data.table(tank7a), on = "dateTime", roll = T, rollends = F][as.data.table(tank7b), on = "dateTime", roll = T, rollends = F][as.data.table(tank8a), on = "dateTime", roll = T, rollends = F][as.data.table(tank1a), on = "dateTime", roll = T, rollends = F] #Use data.table rolling join to match HOBO logger data together by nearest dateTime. Use only the loggers wiht at least 411 observations

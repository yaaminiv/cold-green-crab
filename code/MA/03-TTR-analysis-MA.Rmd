...
- need to figure out how to document changes from flip to not-flip
- within crabs that flip no matter what, changes in TTR

need to pivot so that TTRthresh has a value for each day...group by crab ID?
...
- rm crabs with only one observation
- try rm crabs with only two observations
- stacked bargraph of the following categories:
  - always flipped
  - didn't flip
  - recovered
  - failed recovery

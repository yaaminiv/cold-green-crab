...
anova(TTRthreshNullSex, TTRthreshModelRevised) #Compare models. Marginally significant impact of sex on failure to right.
```
...
TTRthreshModelComparisons <- rbind(broom::tidy(anova(TTRthreshNullTreatment, TTRthreshModel)),
                                   ...
                                   broom::tidy(anova(TTRthreshModelRevised, TTRthreshSource))) #Create a table of model comparison output
TTRthreshModelComparisons
```

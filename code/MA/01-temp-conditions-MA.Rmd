...
tempStats #Significant differences between temperature treatments. Chi-sq: 2941.4, p-value = 0
```
...
cbind(tank1a, tank1b,
  ...
  geom_ribbon(aes(x = dateTime, y = coldMeanMA, ymin = coldMeanMA - coldSDMA, ymax = coldMeanMA + coldSDMA), fill = plotColors[2], alpha = 0.15) +
  geom_hline(yintercept = coldMeanMA, colour = plotColors[2], linetype = 3) +
  geom_line(aes(x = dateTime, y = coldTemp), color = plotColors[2]) +
  geom_ribbon(aes(x = dateTime, y = colderMeanMA, ymin = colderMeanMA - colderSDMA, ymax = colderMeanMA + colderSDMA), fill = plotColors[1], alpha = 0.15) +
  geom_hline(yintercept = colderMeanMA, colour = plotColors[1], linetype = 3) +
...
```{r}
MAconditions <- cbind(tank1a, tank1b,
                      tank2a, tank2b,
                      tank3a, tank3b,
                      tank5a, tank5b,
                      tank6a, tank6b,
